...
const MumbaiOfficeSpace = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Book Office Spaces for rent in Mumbai - Work at your comfort -
          GoFloaters
        </title>
        <meta
          property="og:title"
          content="Book Office Spaces for rent in Mumbai - Work at your comfort -
          GoFloaters"
        />
        <meta
          name="description"
...
export default MumbaiOfficeSpace
export const query = graphql`
  query MumbaiOfficeSpace {
    allListings(
