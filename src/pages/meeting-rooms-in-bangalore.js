...
import SocialImage from "../img/socialimage/meeting-rooms-in-bengaluru.jpg"

const BangaloreMeetingSpaces = props => {
...
export default BangaloreMeetingSpaces
export const query = graphql`
  query BangaloreMeetingSpaces {
    allListings(
      filter: {
