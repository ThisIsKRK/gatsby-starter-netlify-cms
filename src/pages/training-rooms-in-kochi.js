...
const KochiTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Kochi -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Kochi</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Kochi" />
              </div>
            </div>
            <br />
            <div>
...
export default KochiTrainingRooms
export const query = graphql`
  query KochiTrainingRooms {
    allListings(
      filter: { subType: { eq: "Training Room" }, spaceCity: { eq: "Kochi" } }
    ) {
      totalCount
      edges {
        node {
