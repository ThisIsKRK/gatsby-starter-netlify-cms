...
const GurugramWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in Gurugram - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in Gurugram - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in Gurugram</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Gurugram" />
              </div>
            </div>
            <br />
            <div>
...
export default GurugramWorkCafe
export const query = graphql`
  query GurugramWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Gurugram" } }
    ) {
      totalCount
      edges {
        node {
