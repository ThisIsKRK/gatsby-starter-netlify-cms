...
const BengalurumonthlyofficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Office for rent in Bengaluru | Best coworking spaces in Bengaluru | Gofloaters"
        description="Furnished Office Space for rent in Bengaluru with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
...
export default BengalurumonthlyofficeSpace
export const query = graphql`
  query BengalurumonthlyofficeSpace {
    allListings(
      filter: {
