...
const ChennaiWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in Chennai - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in Chennai - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in Chennai</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Chennai" />
              </div>
            </div>
            <br />
            <div>
...
export default ChennaiWorkCafe
export const query = graphql`
  query ChennaiWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Chennai" } }
    ) {
      totalCount
      edges {
        node {
