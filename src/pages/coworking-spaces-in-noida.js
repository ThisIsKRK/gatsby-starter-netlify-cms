...
const NoidaWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in Noida - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in Noida - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in Noida</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Noida" />
              </div>
            </div>
            <br />
            <div>
...
export default NoidaWorkCafe
export const query = graphql`
  query NoidaWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Noida" } }
    ) {
      totalCount
      edges {
        node {
