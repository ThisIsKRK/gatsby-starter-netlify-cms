  ...
  return (
    <div>
      <SEOHeader
        ...
        description="Furnished & Ready-to-move-in office space for rent in Trichy. Flexible plans that suit your needs. Coworking Spaces for teams. All-inclusive pricing."
        socialURL="https://assets.gofloaters.com/socialimage/trichy.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        <div>
...
export const query = graphql`
  query Trichy {
    allListings(
      filter: { subType: { eq: "Office Space" }, spaceCity: { eq: "Trichy" } }
    ) {
      totalCount
      edges {
        node {
