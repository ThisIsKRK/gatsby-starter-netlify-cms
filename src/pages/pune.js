  ...
  return (
    <div>
      <SEOHeader
         ...
         description="Furnished & Ready-to-move-in office space for rent in Pune. Flexible plans that suit your needs. Coworking Spaces for teams. All-inclusive pricing."
        socialURL="https://assets.gofloaters.com/socialimage/pune.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        <div>
