...
const HyderabadTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Hyderabad -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Hyderabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Hyderabad" />
              </div>
            </div>
            <br />
            <div>
...
export default HyderabadTrainingRooms
export const query = graphql`
  query HyderabadTrainingRooms {
    allListings(
      filter: {
