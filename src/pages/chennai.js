    ...
    <div>
      <Helmet>
        <title>
          ...
          Event, Training spaces @ Chennai - GoFloaters
        </title>
        <meta
          name="description"
      ...
      <Layout>
        ...
        <div className="container">
          <ul className="ListingFilter DesktopOnly">
            <li>
              <Link to="/office-spaces-for-rent-in-chennai/" className="active">
                Office Spaces
              </Link>
            </li>
            <li>
              <Link to="/coworking-spaces-in-chennai/">Work Cafe</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/training-rooms-in-chennai/">Training Room</Link>
            </li>
            <li>
              <Link to="/event-spaces-in-chennai/">Event Spaces</Link>
            </li>
          </ul>
