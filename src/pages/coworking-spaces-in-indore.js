...
const IndoreCoworkingSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
          title="Best coworking spaces in Indore | Office for rent in Indore | Gofloaters"
          description="Book furnished coworking spaces in Indore for a day instantly. Great amenities and spacious coworking spaces available in Indore for you to choose from."
        socialURL="https://assets.gofloaters.com/socialimage/coworking-spaces-in-indore.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
          ...
          <div className="container">
            ...
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-indore/" className="active">
                    Coworking Spaces
                  </Link>
                </li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Coworking Spaces in Indore available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default IndoreCoworkingSpace
export const query = graphql`
  query IndoreCoworkingSpace {
    allListings(
      filter: {
