...
const GaziabadTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Gaziabad -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Gaziabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Gaziabad" />
              </div>
            </div>
            <br />
            <div>
...
export default GaziabadTrainingRooms
export const query = graphql`
  query GaziabadTrainingRooms {
    allListings(
      filter: {
