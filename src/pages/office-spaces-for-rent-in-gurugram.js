...
const GurugramOfficeSpace = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Book Office Spaces for rent in Gurugram - Work at your comfort -
          GoFloaters
        </title>
        <meta
          property="og:title"
          content="Book Office Spaces for rent in Gurugram - Work at your comfort -
          GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="office-space">
          <h1>Office Spaces in Gurugram</h1>
        </HeaderBanner>
...
export default GurugramOfficeSpace
export const query = graphql`
  query GurugramOfficeSpace {
    allListings(
