...
const GurugramDailyOfficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Office for rent in Gurgaon | Best coworking spaces in Gurugram | Gofloaters"
        description="Furnished Office Space for rent in Gurugram with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
        socialURL="https://assets.gofloaters.com/socialimage/office-spaces-for-rent-in-gurugram.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="listingpageTitle">Monthly Office Spaces in Gurugram</h1>
              ...
              <p style={{ fontSize: "13px" }}>
                Your search for best office space on rent in Gurgaon has a
                destination at GoFloaters. The range of a dedicated desk in
                Gurgaon is from Rs 4000 / month to Rs 8000 / month. Some of the
                popular localities are Udyog Vihar, Golf Course Road, Huda city
                Centre and Cyber City.
              </p>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Gurugram available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
          ...
          <div className="col-md-12">
            <h4 style={{ fontWeight: "bold" }}>Office Space in Gurgaon </h4>

            <p>
              Looking for shared office spaces in Gurgaon? Book the best office
            ...
            <br />
            <h4 style={{ fontWeight: "bold" }}>
              Why Choose GoFloaters to book your office space in Gurgaon
            </h4>
            <p>
...
export default GurugramDailyOfficeSpace
export const query = graphql`
  query GurugramDailyOfficeSpace {
    allListings(
      filter: {
