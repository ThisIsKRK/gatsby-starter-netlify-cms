...
const WorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces at Cafés - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces at Cafés - GoFloaters"
        />
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="gofloaters chennai, Book Private Office, Shared office, Coworking Space"
        />
      </Helmet>
      <Layout>
