...
const MumbaiTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Mumbai -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Mumbai</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Mumbai" />
              </div>
            </div>
            <br />
            <div>
...
export default MumbaiTrainingRooms
export const query = graphql`
  query MumbaiTrainingRooms {
    allListings(
      filter: { subType: { eq: "Training Room" }, spaceCity: { eq: "Mumbai" } }
    ) {
      totalCount
      edges {
        node {
