...
const Ghaziabad = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Best Coworking Spaces in Ghaziabad | Office for rent in Ghaziabad | Gofloaters"
        description="Furnished & Ready-to-move-in office space for rent in Ghaziabad. Flexible plans that suit your needs. Coworking Spaces for teams. All-inclusive pricing."
