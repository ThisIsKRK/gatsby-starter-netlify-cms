  ...
  return (
    <div>
      <SEOHeader
        ...
        description="Furnished & Ready-to-move-in office space for rent in Kolkata. Flexible plans that suit your needs. Coworking Spaces for teams. All-inclusive pricing."
        socialURL="https://assets.gofloaters.com/socialimage/kolkata.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        <div>
...
export const query = graphql`
  query Kolkata {
    allListings(
      filter: { subType: { eq: "Office Space" }, spaceCity: { eq: "Kolkata" } }
    ) {
      totalCount
      edges {
        node {
