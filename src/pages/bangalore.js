  ...
  return (
    <div>
      <SEOHeader
        ...
        description="Furnished & Ready-to-move-in office space for rent in Bangalore. Flexible plans that suit your needs. Coworking Spaces for teams. All-inclusive pricing."
