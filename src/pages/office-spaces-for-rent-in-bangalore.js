...
const BangaloremonthlyofficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
       title="Office for rent in Bangalore | Best coworking spaces in Bangalore | Gofloaters"
       description="Furnished Office Space for rent in Bangalore with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
      ...
      <Layout>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                ...
                Monthly Office Spaces in Bangalore
                </h1>
                ...
                <p style={{ fontSize: "13px" }}>
                  If you are looking for the best office space on rent in
                  Bengaluru then you have come to the right page. An average
                  cost of a dedicated desk in Bengaluru is in the range of Rs
                  4000 / month to Rs 8000 / month. Some of the popular
                  localities are{" "}
                  <a href="https://gofloaters.com/search/?city=Koramangala,%20Bengaluru,%20%20Karnataka&lat=12.9351929&lng=77.62448069999999&spaceType=monthlyofficeSpace">
                    Koramangala
                  </a>
                  ,{" "}
                  <a href="https://gofloaters.com/search/?city=Indiranagar,%20Bengaluru,%20%20Karnataka&lat=12.9783692&lng=77.6408356&spaceType=monthlyofficeSpace">
                    Indiranagar
                  </a>
                  , <a href="https://gofloaters.com/search?city=Mahatma%20Gandhi%20Rd,%20Bengaluru,%20Karnataka&lat=12.9747066&lng=77.6072206&spaceType=monthlyofficeSpace">MG Road</a>,  <a href="https://gofloaters.com//search?city=J.%20P.%20Nagar,%20Bengaluru&lat=12.8896976&lng=77.5605652&spaceType=monthlyofficeSpace">JP Nagar</a> and <a href="https://gofloaters.com/search?city=Malleshwaram,%20Bengaluru&lat=13.0076971&lng=77.5585626&spaceType=monthlyofficeSpace">Malleswaram</a>.
                  <br />
                </p>
                <SearchForm spacetype="monthlyofficeSpace"></SearchForm>
                <br></br>
                <div className="padding-20"></div>
              </div>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Bangalore available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
          ...
          <div className="col-md-12">
            <h4 style={{ fontWeight: "bold" }}>Office Space in Bangalore</h4>
            <p>
              Looking for office space for rent in Bangalore? Book the best
              office space in Bangalore for teams of all sizes with all
              amenities from hot desks to private cabins.
              <br />
              <br />
              ...
              <br />
              <br />
              Bengaluru, being the startup capital of India has probably the
            ...
            <h4 style={{ fontWeight: "bold" }}>
              Top Office Space Locations in Bangalore
            </h4>
            <br />
            ...
            <br />
            <h4 style={{ fontWeight: "bold" }}>
              Why Choose GoFloaters to book your office space in Bangalore
            </h4>
            <p>
...
export default BangaloremonthlyofficeSpace
export const query = graphql`
  query BangaloremonthlyofficeSpace {
    allListings(
      filter: {
