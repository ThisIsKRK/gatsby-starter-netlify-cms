...
const NewDelhiTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in New Delhi -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in New Delhi</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="New Delhi" />
              </div>
            </div>
            <br />
            <div>
...
export default NewDelhiTrainingRooms
export const query = graphql`
  query NewDelhiTrainingRooms {
    allListings(
      filter: {
