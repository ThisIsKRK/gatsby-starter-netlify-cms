...
const HyderabadEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Hyderabad - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Hyderabad - GoFloaters"
        ></meta>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="event-space">
          {" "}
          <h1>Event Spaces in Hyderabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Hyderabad" />
              </div>
            </div>
            <br />
            <div>
...
export default HyderabadEventSpaces
export const query = graphql`
  query HyderabadEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Hyderabad" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
