    ...
    <div>
      <Helmet>
        <title>
          ...
          Event, Training spaces @ NewDelhi - GoFloaters
        </title>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="office-space">
          <h1>Office Spaces in NewDelhi</h1>
        </HeaderBanner>
        <div className="container">
          <ul className="ListingFilter DesktopOnly">
            ...
            <li>
              <Link to="/coworking-spaces-in-new-delhi/">Work Cafe</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/training-rooms-in-new-delhi/">Training Room</Link>
            </li>
            <li>
              <Link to="/event-spaces-in-new-delhi/">Event Spaces</Link>
            </li>
          </ul>
