...
import SocialImage from "../img/socialimage/meeting-rooms-in-kochi.jpg"
const KochiMeetingSpaces = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Book Conference Rooms & Meeting Rooms in Kochi at GoFloaters"
        description="Book Meeting Rooms In Kochi With GoFloaters. Conduct your meetings professionally with the well-equipped Conference rooms in Kochi."
        socialURL="https://assets.gofloaters.com/socialimage/meeting-rooms-in-kochi.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <h1 className="listingpageTitle">Meeting Spaces in Kochi</h1>
              ...
              <div className="col-md-12">
                <MeetingLocationSwitch city="Kochi" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-kochi/">Coworking Spaces</Link>
                </li>
                
                <li>
                  <Link to="/meeting-rooms-in-kochi/" className="active">
                    Meeting Spaces
                  </Link>
                </li>
                <li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Meeting Spaces in Kochi available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default KochiMeetingSpaces
export const query = graphql`
  query KochiMeetingSpaces {
    allListings(
      filter: { subType: { eq: "Meeting Space" }, spaceCity: { eq: "Kochi" } }
    ) {
      totalCount
      edges {
        node {
