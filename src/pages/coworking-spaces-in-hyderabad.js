    ...
    <div>
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in Hyderabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Hyderabad" />
              </div>
            </div>
            <br />
            <div>
...
export default HyderabadWorkCafe
export const query = graphql`
  query HyderabadWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Hyderabad" } }
    ) {
      totalCount
      edges {
        node {
