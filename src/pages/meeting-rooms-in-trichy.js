...
import SocialImage from "../img/socialimage/meeting-rooms-in-trichy.jpg"

const TrichyMeetingSpaces = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Book Conference Rooms & Meeting Rooms in Trichy at GoFloaters"
        description="Book Meeting Rooms In Trichy With GoFloaters. Conduct your meetings professionally with the well-equipped Conference rooms in Trichy."
        socialURL="https://assets.gofloaters.com/socialimage/meeting-rooms-in-trichy.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <h1 className="listingpageTitle">Meeting Spaces in Trichy</h1>
              ...
              <div className="col-md-12">
                <MeetingLocationSwitch city="Trichy" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-trichy/">
                    Coworking Spaces
                  </Link>
                </li>
               
                <li>
                  <Link to="/meeting-rooms-in-trichy/" className="active">
                    Meeting Spaces
                  </Link>
                </li>
                <li>
                  <Link to="/office-spaces-for-rent-in-trichy/">
                    Office Spaces
                  </Link>
                </li>
              </ul>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Meeting Spaces in Trichy available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default TrichyMeetingSpaces
export const query = graphql`
  query TrichyMeetingSpaces {
    allListings(
      filter: { subType: { eq: "Meeting Space" }, spaceCity: { eq: "Trichy" } }
    ) {
      totalCount
      edges {
        node {
