...
const NewDelhiMeetingSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Meeting spaces on Hourly, Daily & Monthly Rental in New Delhi -
          GoFloaters
        </title>
        <meta
          property="og:title"
          content="Meeting spaces on Hourly, Daily & Monthly Rental in New Delhi - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="meeting-space">
          {" "}
          <h1>Meeting Spaces in New Delhi</h1>
        </HeaderBanner>
