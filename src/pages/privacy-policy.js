          ...
          <div className="row">
            <div className="col-md-12 ">
              <p>
                ...
                <br />
                Welcome to{" "}
                <strong>SMBSure Business Solutions Private Limited</strong>.
                <br />
                <strong>SMBSure Business Solutions Private Limited</strong>{" "}
                (“us”, “we”, or “our”) operates <strong>GoFloaters app </strong>
                and <strong>gofloaters.com</strong> (hereinafter referred to as{" "}
                <strong>“Service”</strong>).
                <br />
                Our Privacy Policy governs your visit to{" "}
                <strong>GoFloaters app </strong>and{" "}
                <strong>gofloaters.com</strong>, and explains how we collect,
                ...
                <br />
                <br />
                <strong>SERVICE</strong> means the GoFloaters app and
                gofloaters.com website operated by SMBSure Business Solutions
                Private Limited.
                <br />
                <br />
                ...
                <br />
                0.3. <strong>Security Cookies:</strong> We use Security Cookies
                for security purposes.
                <br />
                0.4. <strong>Advertising Cookies:</strong> Advertising Cookies
                ...
                <br />
                <br />
                13. <strong>Behavioral Remarketing</strong>
                <br />
                ...
                <br />
                <br />
                15. <strong>Links to Other Sites</strong>
                <br />
                ...
                <br />
                <br />
                16. <strong>Children’s Privacy</strong>
                <br />
                ...
                <br />
                <br />
                18. <strong>Contact Us</strong>
                <br />
                If you have any questions about this Privacy Policy, please
                contact us by email: <strong>support@gofloaters.com</strong>.
              </p>
            </div>
          </div>
        </div>
