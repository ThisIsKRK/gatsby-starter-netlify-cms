...
const NoidaTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Noida -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Noida</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Noida" />
              </div>
            </div>
            <br />
            <div>
...
export default NoidaTrainingRooms
export const query = graphql`
  query NoidaTrainingRooms {
    allListings(
      filter: { subType: { eq: "Training Room" }, spaceCity: { eq: "Noida" } }
    ) {
      totalCount
      edges {
        node {
