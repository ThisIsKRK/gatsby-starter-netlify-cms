...
const BengaluruEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Bengaluru - GoFloaters</title>
        <meta name="og:title" content="Event spaces - GoFloaters"></meta>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="event-space">
          {" "}
          <h1>Event Spaces in Bengaluru</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Bengaluru" />
              </div>
            </div>
            <br />
            <div>
...
export default BengaluruEventSpaces
export const query = graphql`
  query BengaluruEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Bengaluru" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
