  ...
  return (
    <div>
      <SEOHeader
        ...
        description="Furnished & Ready-to-move-in office space for rent in Madurai. Flexible plans that suit your needs. Coworking Spaces for teams. All-inclusive pricing."
        socialURL="https://assets.gofloaters.com/socialimage/madurai.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        <div>
...
export const query = graphql`
  query Madurai {
    allListings(
      filter: { subType: { eq: "Office Space" }, spaceCity: { eq: "Madurai" } }
    ) {
      totalCount
      edges {
        node {
