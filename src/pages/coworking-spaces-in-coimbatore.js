...
const CoimbatoreWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in Coimbatore - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in Coimbatore - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in Coimbatore</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Coimbatore" />
              </div>
            </div>
            <br />
            <div>
...
export default CoimbatoreWorkCafe
export const query = graphql`
  query CoimbatoreWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Coimbatore" } }
    ) {
      totalCount
      edges {
        node {
