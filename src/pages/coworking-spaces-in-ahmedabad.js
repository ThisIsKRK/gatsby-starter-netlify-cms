...
const AhmedabadCoworkingSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Best coworking spaces in Ahmedabad | Office for rent in Ahmedabad | Gofloaters"
        description="Book furnished coworking spaces in Ahmedabad for a day instantly. Great amenities and spacious coworking spaces available in Ahmedabad for you to choose from."
        socialURL="https://assets.gofloaters.com/socialimage/coworking-spaces-in-ahmedabad.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
          ...
          <div className="container">
            ...
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-ahmedabad/" className="active">
                    Coworking Spaces
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/office-spaces-for-rent-in-ahmedabad/">
                    Office Spaces
                  </Link>
                </li>
              </ul>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Coworking Spaces in Ahmedabad available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default AhmedabadCoworkingSpace
export const query = graphql`
  query AhmedabadCoworkingSpace {
    allListings(
      filter: {
