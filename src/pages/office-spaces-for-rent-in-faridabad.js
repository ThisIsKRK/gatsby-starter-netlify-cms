...
const FaridabadOfficeSpace = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Book Office Spaces for rent in Faridabad - Work at your comfort -
          GoFloaters
        </title>
        <meta
          property="og:title"
          content="Book Office Spaces for rent in Faridabad - Work at your comfort -
          GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="office-space">
          <h1>Office Spaces in Faridabad</h1>
        </HeaderBanner>
...
export default FaridabadOfficeSpace
export const query = graphql`
  query FaridabadOfficeSpace {
    allListings(
      filter: {
