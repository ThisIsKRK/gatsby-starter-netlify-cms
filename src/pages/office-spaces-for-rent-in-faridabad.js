...
const FaridabadDailyOfficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
         title="Office for rent in Faridabad | Best coworking spaces in Faridabad | Gofloaters"
         description="Furnished Office Space for rent in Faridabad with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
        socialURL="https://assets.gofloaters.com/socialimage/office-spaces-for-rent-in-faridabad.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="listingpageTitle">Monthly Office Spaces in Faridabad</h1>
          ...
          <div className="filterbar" style={{ marginTop: 15 }}>
            <ul className="SearchListingFilter scrollmenu">
              <li>
                <Link to="/coworking-spaces-in-faridabad/">
                  Coworking Spaces
                </Link>
              </li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Faridabad available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default FaridabadDailyOfficeSpace
export const query = graphql`
  query FaridabadDailyOfficeSpace {
    allListings(
      filter: {
