...
const CoimbatoreTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Coimbatore -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Coimbatore</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Coimbatore" />
              </div>
            </div>
            <br />
            <div>
...
export default CoimbatoreTrainingRooms
export const query = graphql`
  query CoimbatoreTrainingRooms {
    allListings(
      filter: {
