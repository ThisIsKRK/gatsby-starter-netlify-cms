...
const MaduraimonthlyofficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
       title="Office for rent in Madurai | Best coworking spaces in Madurai | Gofloaters"
       description="Furnished Office Space for rent in Madurai with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
        socialURL="https://assets.gofloaters.com/socialimage/office-spaces-for-rent-in-madurai.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                ...
                Monthly Office Spaces in Madurai
                </h1>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Madurai available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default MaduraimonthlyofficeSpace
export const query = graphql`
  query MaduraimonthlyofficeSpace {
    allListings(
      filter: {
