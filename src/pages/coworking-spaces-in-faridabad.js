...
import SocialImage from "../img/socialimage/office-spaces-for-rent-in-faridabad.jpg"
import { graphql, Link } from "gatsby"

const FaridabadCoworkingSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Best coworking spaces in Faridabad | Office for rent in Faridabad | Gofloaters"
        description="Book furnished coworking spaces in Faridabad for a day instantly. Great amenities and spacious coworking spaces available in Faridabad for you to choose from."
        socialURL="https://assets.gofloaters.com/socialimage/coworking-spaces-in-faridabad.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-12">
              <OfficeSpaceLocationSwitch city="Faridabad" />
            </div>
          </div>
          <div className="filterbar" style={{ marginTop: 15 }}>
            <ul className="SearchListingFilter scrollmenu">
              <li>
                <Link to="/coworking-spaces-in-faridabad/" className="active">
                  Coworking Spaces
                </Link>
              </li>

              <li>
                <Link to="/meeting-rooms-in-faridabad/">Meeting Spaces</Link>
              </li>
              <li>
                <Link to="/office-spaces-for-rent-in-faridabad/">
                  Office Spaces
                </Link>
              </li>
            </ul>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Coworking Spaces in Faridabad available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default FaridabadCoworkingSpace
export const query = graphql`
  query FaridabadCoworkingSpace {
    allListings(
      filter: {
        subType: { eq: "Office Space" }
        spaceCity: { eq: "Faridabad" }
