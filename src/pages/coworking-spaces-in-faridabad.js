...
const FaridabadWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in Faridabad - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in Faridabad - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in Faridabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Faridabad" />
              </div>
            </div>
            <br />
            <div>
...
export default FaridabadWorkCafe
export const query = graphql`
  query FaridabadWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Faridabad" } }
    ) {
      totalCount
      edges {
        node {
