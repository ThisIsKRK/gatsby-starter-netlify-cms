...
const NewDelhiEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in New Delhi - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in New Delhi - GoFloaters"
        ></meta>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="event-space">
          {" "}
          <h1>Event Spaces in New Delhi</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="New Delhi" />
              </div>
            </div>
            <br />
            <div>
...
export default NewDelhiEventSpaces
export const query = graphql`
  query NewDelhiEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "New Delhi" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
