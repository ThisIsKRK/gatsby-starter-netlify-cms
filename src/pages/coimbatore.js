  ...
  return (
    <div>
      <SEOHeader
       ...
       description="Furnished & Ready-to-move-in office space for rent in Coimbatore. Flexible plans that suit your needs. Coworking Spaces for teams. All-inclusive pricing."
        socialURL="https://assets.gofloaters.com/socialimage/coimbatore.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        <div>
