    ...
    <div>
      <Helmet>
        <title>
          ...
          Event, Training spaces @ Coimbatore - GoFloaters
        </title>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="office-space">
          <h1>Office Spaces in Coimbatore</h1>
        </HeaderBanner>
        <div className="container">
          <ul className="ListingFilter DesktopOnly">
            ...
            <li>
              <Link to="/coworking-spaces-in-coimbatore/">Work Cafe</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/training-rooms-in-coimbatore/">Training Room</Link>
            </li>
            <li>
              <Link to="/event-spaces-in-coimbatore/">Event Spaces</Link>
            </li>
          </ul>
