...
const BengaluruTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Bengaluru -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Bengaluru</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Bengaluru" />
              </div>
            </div>
            <br />
            <div>
...
export default BengaluruTrainingRooms
export const query = graphql`
  query BengaluruTrainingRooms {
    allListings(
      filter: {
