...
const FaridabadMeetingSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Meeting spaces on Hourly, Daily & Monthly Rental in Faridabad -
          GoFloaters
        </title>
        <meta
          property="og:title"
          content="Meeting spaces on Hourly, Daily & Monthly Rental in Faridabad - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="meeting-space">
          {" "}
          <h1>Meeting Spaces in Faridabad</h1>
        </HeaderBanner>
