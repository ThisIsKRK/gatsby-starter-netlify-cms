...
import SocialImage from "../img/socialimage/meeting-rooms-in-faridabad.jpg"
const FaridabadMeetingSpaces = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Book Conference Rooms & Meeting Rooms in Faridabad at GoFloaters"
        description="Book Meeting Rooms In Faridabad With GoFloaters. Conduct your meetings professionally with the well-equipped Conference rooms in Faridabad."
        socialURL="https://assets.gofloaters.com/socialimage/meeting-rooms-in-faridabad.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <MeetingLocationSwitch city="Faridabad" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                ...
                <li>
                  <Link to="/meeting-rooms-in-faridabad/" className="active">
                    Meeting Spaces
                  </Link>
                </li>
                <li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Meeting Spaces in Faridabad available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default FaridabadMeetingSpaces
export const query = graphql`
  query FaridabadMeetingSpaces {
    allListings(
      filter: {
