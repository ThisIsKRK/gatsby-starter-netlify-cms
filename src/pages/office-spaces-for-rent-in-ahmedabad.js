...
const AhmedabadDailyOfficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
       title="Office for rent in Ahmedabad | Best coworking spaces in Ahmedabad | Gofloaters"
       description="Furnished Office Space for rent in Ahmedabad with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
        socialURL="https://assets.gofloaters.com/socialimage/office-spaces-for-rent-in-ahmedabad.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="listingpageTitle">Monthly Office Spaces in Ahmedabad</h1>
            ...
            <div className="col-md-12">
              <OfficeSpaceLocationSwitch city="Ahmedabad" />
            </div>
          </div>
          <div className="filterbar" style={{ marginTop: 15 }}>
            <ul className="SearchListingFilter scrollmenu">
              <li>
                <Link to="/coworking-spaces-in-ahmedabad/">
                  Coworking Spaces
                </Link>
              </li>
             
              <li>
                <Link to="/meeting-rooms-in-ahmedabad/">Meeting Spaces</Link>
              </li>
              <li>
                <Link
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Ahmedabad available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default AhmedabadDailyOfficeSpace
export const query = graphql`
  query AhmedabadDailyOfficeSpace {
    allListings(
      filter: {
        subType: { eq: "Office Space" }
        spaceCity: { eq: "Ahmedabad" }
