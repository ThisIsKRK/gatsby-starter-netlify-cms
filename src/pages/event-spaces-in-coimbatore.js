...
const CoimbatoreEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Coimbatore - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Coimbatore - GoFloaters"
        ></meta>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="event-space">
          {" "}
          <h1>Event Spaces in Coimbatore</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Coimbatore" />
              </div>
            </div>
            <br />
            <div>
...
export default CoimbatoreEventSpaces
export const query = graphql`
  query CoimbatoreEventSpaces {
    allListings(
      filter: {
        spaceCity: { eq: "Coimbatore" }
        subType: { eq: "Event Space" }
      }
    ) {
      totalCount
      edges {
