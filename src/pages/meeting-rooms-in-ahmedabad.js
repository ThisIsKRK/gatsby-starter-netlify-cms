...
const AhmedabadMeetingSpaces = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Book Conference Rooms & Meeting Rooms in Ahmedabad at GoFloaters"
        description="Book Meeting Rooms In Ahmedabad With GoFloaters. Conduct your meetings professionally with the well-equipped Conference rooms in Ahmedabad."
        socialURL="https://assets.gofloaters.com/socialimage/meeting-rooms-in-ahmedabad.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <MeetingLocationSwitch city="Ahmedabad" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-ahmedabad/">Coworking Spaces</Link>
                </li>
                
                <li>
                  <Link to="/meeting-rooms-in-ahmedabad/" className="active">
                    Meeting Spaces
                  </Link>
                </li>
                <li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Meeting Spaces in Ahmedabad available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default AhmedabadMeetingSpaces
export const query = graphql`
  query AhmedabadMeetingSpaces {
    allListings(
      filter: {
