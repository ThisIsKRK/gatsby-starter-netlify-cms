    ...
    <div>
      <Helmet>
        <title>
          ...
          Event, Training spaces @ Noida - GoFloaters
        </title>
        <meta
          name="description"
      ...
      <Layout>
        ...
        <div className="container">
          <ul className="ListingFilter DesktopOnly">
            ...
            <li>
              <Link to="/coworking-spaces-in-noida/">Work Cafe</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/training-rooms-in-noida/">Training Room</Link>
            </li>
            <li>
              <Link to="/event-spaces-in-noida/">Event Spaces</Link>
            </li>
          </ul>
