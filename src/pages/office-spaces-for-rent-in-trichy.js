...
const TrichymonthlyofficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Office for rent in Trichy | Best coworking spaces in Trichy | Gofloaters"
        description="Furnished Office Space for rent in Trichy with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
        socialURL="https://assets.gofloaters.com/socialimage/office-spaces-for-rent-in-trichy.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <h1 className="listingpageTitle">Monthly Office Spaces in Trichy</h1>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Trichy available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default TrichymonthlyofficeSpace
export const query = graphql`
  query TrichymonthlyofficeSpace {
    allListings(
      filter: {
