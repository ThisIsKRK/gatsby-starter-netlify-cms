...
const KochiOfficeSpace = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Book Office Spaces for rent in Kochi - Work at your comfort -
          GoFloaters
        </title>
        <meta
          property="og:title"
          content="Book Office Spaces for rent in Kochi - Work at your comfort -
          GoFloaters"
        />
        <meta
          name="description"
...
export default KochiOfficeSpace
export const query = graphql`
  query KochiOfficeSpace {
    allListings(
