...
import SocialImage from "../img/socialimage/office-spaces-for-rent-in-kochi.jpg"
import { graphql, Link } from "gatsby"

const KochiDailyOfficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Office for rent in Kochi | Best coworking spaces in Kohci | Gofloaters"
        description="Furnished Office Space for rent in Kochi with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
        socialURL="https://assets.gofloaters.com/socialimage/office-spaces-for-rent-in-kochi.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="listingpageTitle">Monthly Office Spaces in Kochi</h1>
          ...
          <div className="filterbar" style={{ marginTop: 15 }}>
            <ul className="SearchListingFilter scrollmenu">
              ...
              <li>
                <Link to="/office-spaces-for-rent-in-kochi/" className="active">
                  Office Spaces
                </Link>
              </li>
            </ul>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Kochi available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default KochiDailyOfficeSpace
export const query = graphql`
  query KochiDailyOfficeSpace {
    allListings(
      filter: {
