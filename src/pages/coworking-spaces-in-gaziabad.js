...
const GaziabadWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in Gaziabad - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in Gaziabad - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in Gaziabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Gaziabad" />
              </div>
            </div>
            <br />
            <div>
...
export default GaziabadWorkCafe
export const query = graphql`
  query GaziabadWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Gaziabad" } }
    ) {
      totalCount
      edges {
        node {
