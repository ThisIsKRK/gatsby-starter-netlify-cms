...
const GaziabadCoworkingSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Best coworking spaces in Gaziabad | Office for rent in Gaziabad | Gofloaters"
        description="Book furnished coworking spaces in Gaziabad for a day instantly. Great amenities and spacious coworking spaces available in Gaziabad for you to choose from."
        socialURL="https://assets.gofloaters.com/socialimage/coworking-spaces-in-gaziabad.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div className="container">
          ...
          <div className="filterbar" style={{ marginTop: 15 }}>
            <ul className="SearchListingFilter scrollmenu">
              <li>
                <Link to="/coworking-spaces-in-gaziabad/" className="active">
                  Coworking Spaces
                </Link>
              </li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Coworking Spaces in Gaziabad available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default GaziabadCoworkingSpace
export const query = graphql`
  query GaziabadCoworkingSpace {
    allListings(
      filter: {
