...
import SocialImage from "../img/socialimage/meeting-rooms-in-madurai.jpg"

const MaduraiMeetingSpaces = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Book Conference Rooms & Meeting Rooms in Madurai at GoFloaters"
        description="Book Meeting Rooms In Madurai With GoFloaters. Conduct your meetings professionally with the well-equipped Conference rooms in Madurai."
        socialURL="https://assets.gofloaters.com/socialimage/meeting-rooms-in-madurai.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <MeetingLocationSwitch city="Madurai" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-madurai/">
                    Coworking Spaces
                  </Link>
                </li>
                
                <li>
                  <Link to="/meeting-rooms-in-madurai/" className="active">
                    Meeting Spaces
                  </Link>
                </li>
                <li>
                  <Link to="/office-spaces-for-rent-in-madurai/">
                    Office Spaces
                  </Link>
                </li>
              </ul>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Meeting Spaces in Madurai available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default MaduraiMeetingSpaces
export const query = graphql`
  query MaduraiMeetingSpaces {
    allListings(
      filter: { subType: { eq: "Meeting Space" }, spaceCity: { eq: "Madurai" } }
    ) {
      totalCount
      edges {
        node {
