...
const PuneEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Pune - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Pune - GoFloaters"
        ></meta>
        <meta
          name="description"
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Pune" />
              </div>
            </div>
            <br />
            <div>
...
export default PuneEventSpaces
export const query = graphql`
  query PuneEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Pune" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
