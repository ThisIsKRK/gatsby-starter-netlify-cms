...
const IndoreDailyOfficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
       title="Office for rent in Indore | Best coworking spaces in Indore | Gofloaters"
       description="Furnished Office Space for rent in Indore with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
        socialURL="https://assets.gofloaters.com/socialimage/office-spaces-for-rent-in-indore.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="listingpageTitle">Monthly Office Spaces in Indore</h1>
            ...
            <div className="col-md-12">
              <OfficeSpaceLocationSwitch city="Indore" />
            </div>
          </div>
          <div className="filterbar" style={{ marginTop: 15 }}>
            <ul className="SearchListingFilter scrollmenu">
              <li>
                <Link to="/coworking-spaces-in-indore/">Coworking Spaces</Link>
              </li>
            
              <li>
                <Link to="/meeting-rooms-in-indore/">Meeting Spaces</Link>
              </li>
              <li>
                <Link
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Indore available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default IndoreDailyOfficeSpace
export const query = graphql`
  query IndoreDailyOfficeSpace {
    allListings(
      filter: {
