...
const FaridabadTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Faridabad -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Faridabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Faridabad" />
              </div>
            </div>
            <br />
            <div>
...
export default FaridabadTrainingRooms
export const query = graphql`
  query FaridabadTrainingRooms {
    allListings(
      filter: {
