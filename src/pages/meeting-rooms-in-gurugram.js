...
const GurugramMeetingSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Meeting spaces on Hourly, Daily & Monthly Rental in Gurugram -
          GoFloaters
        </title>
        <meta
          property="og:title"
          content="Meeting spaces on Hourly, Daily & Monthly Rental in Gurugram - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="meeting-space">
          {" "}
          <h1>Meeting Spaces in Gurugram</h1>
        </HeaderBanner>
