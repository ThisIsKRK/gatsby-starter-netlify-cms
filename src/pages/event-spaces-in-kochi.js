...
const KochiEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Kochi - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Kochi - GoFloaters"
        ></meta>
        <meta
          name="description"
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Kochi" />
              </div>
            </div>
            <br />
            <div>
...
export default KochiEventSpaces
export const query = graphql`
  query KochiEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Kochi" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
