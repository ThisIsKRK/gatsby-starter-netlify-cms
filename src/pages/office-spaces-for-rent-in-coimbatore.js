...
const CoimbatoreDailyOfficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Office for rent in Coimbatore | Best coworking spaces in Coimbatore | Gofloaters"
        description="Furnished Office Space for rent in Coimbatore with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
        socialURL="https://assets.gofloaters.com/socialimage/office-spaces-for-rent-in-coimbatore.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
             <h1 className="listingpageTitle">Monthly Office Spaces in Coimbatore
              </h1>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Coimbatore available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default CoimbatoreDailyOfficeSpace
export const query = graphql`
  query CoimbatoreDailyOfficeSpace {
    allListings(
      filter: {
