...
const MaduraiCoworkingSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
           title="Best coworking spaces in Madurai | Office for rent in Madurai | Gofloaters"
           description="Book furnished coworking spaces in Madurai for a day instantly. Great amenities and spacious coworking spaces available in Madurai for you to choose from."
        socialURL="https://assets.gofloaters.com/socialimage/coworking-spaces-in-madurai.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <OfficeSpaceLocationSwitch city="Madurai" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-madurai/" className="active">
                    Coworking Spaces
                  </Link>
                </li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Coworking Spaces in Madurai available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default MaduraiCoworkingSpace
export const query = graphql`
  query MaduraiCoworkingSpace {
    allListings(
      filter: {
        subType: { eq: "Office Space" }
        spaceCity: { eq: "Madurai" }
