...
const KolkataDailyOfficeSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
       title="Office for rent in Kolkata | Best coworking spaces in Kolkata | Gofloaters"
       description="Furnished Office Space for rent in Kolkata with High-Speed Internet. Great amenities and spacious offices available for you to choose from. Book Instantly."
      ...
      <Layout>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <h1 className="listingpageTitle">Monthly Office Spaces in Kolkata</h1>
          ...
          <div className="filterbar" style={{ marginTop: 15 }}>
            <ul className="SearchListingFilter scrollmenu">
              <li>
                <Link to="/coworking-spaces-in-kolkata/">Coworking Spaces</Link>
              </li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Office Spaces in Kolkata available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default KolkataDailyOfficeSpace
export const query = graphql`
  query KolkataDailyOfficeSpace {
    allListings(
      filter: {
