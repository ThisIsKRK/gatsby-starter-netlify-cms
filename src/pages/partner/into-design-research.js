...
const Into = () => {
  return (
    <div>
      <Helmet>
        <title>Into Design Researh - Partner Perks of GoFloaters</title>
      </Helmet>
      <Layout>
        <HeaderBanner>
          ...
          <div className="col-md-12 breadcrumb-container text-center">
            <p>
              <Link to="/our-community-perks">Community Benefits</Link> / Into
              Design Researh
            </p>
          </div>
        </HeaderBanner>
        <div className="container">
          <div className="row">
            <div className="col-md-3 text-center">
              <img
                src="https://assets.gofloaters.com/partner/Into-Logo.png"
                alt="Into Design Researh"
              ></img>
            </div>
