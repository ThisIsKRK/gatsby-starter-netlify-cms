...
const KolkataMeetingSpaces = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Book Conference Rooms & Meeting Rooms in Kolkata at GoFloaters"
        description="Book Meeting Rooms In Kolkata With GoFloaters. Conduct your meetings professionally with the well-equipped Conference rooms in Kolkata."
      ...
      <Layout>
        ...
        <div>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <MeetingLocationSwitch city="Kolkata" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-kolkata/">
                    Coworking Spaces
                  </Link>
                </li>
               
                <li>
                  <Link to="/meeting-rooms-in-kolkata/" className="active">
                    Meeting Spaces
                  </Link>
                </li>
                <li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Meeting Spaces in Kolkata available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default KolkataMeetingSpaces
export const query = graphql`
  query KolkataMeetingSpaces {
    allListings(
      filter: { subType: { eq: "Meeting Space" }, spaceCity: { eq: "Kolkata" } }
    ) {
      totalCount
      edges {
        node {
