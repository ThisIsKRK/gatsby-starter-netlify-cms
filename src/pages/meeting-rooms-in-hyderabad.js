...
const HyderabadMeetingSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Meeting spaces on Hourly, Daily & Monthly Rental in Hyderabad -
          GoFloaters
        </title>
        <meta
          property="og:title"
          content="Meeting spaces on Hourly, Daily & Monthly Rental in Hyderabad - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="meeting-space">
          {" "}
          <h1>Meeting Spaces in Hyderabad</h1>
        </HeaderBanner>
