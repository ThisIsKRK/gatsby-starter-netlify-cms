...
const ChennaiTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Chennai -
          GoFloaters
        </title>
        <meta
          property="og:title"
      ...
      <Layout>
        <HeaderBanner headerclass="training-space">
          {" "}
          <h1>Training Spaces in Chennai</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Chennai" />
              </div>
            </div>
            <br />
            <div>
...
export default ChennaiTrainingRooms
export const query = graphql`
  query ChennaiTrainingRooms {
    allListings(
      filter: { subType: { eq: "Training Room" }, spaceCity: { eq: "Chennai" } }
    ) {
      totalCount
      edges {
        node {
