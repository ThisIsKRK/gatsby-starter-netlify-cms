...
const GurugramEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Gurugram - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Gurugram - GoFloaters"
        ></meta>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="event-space">
          {" "}
          <h1>Event Spaces in Gurugram</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Gurugram" />
              </div>
            </div>
            <br />
            <div>
...
export default GurugramEventSpaces
export const query = graphql`
  query GurugramEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Gurugram" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
