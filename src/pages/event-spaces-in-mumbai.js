...
const MumbaiEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Mumbai - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Mumbai - GoFloaters"
        ></meta>
        <meta
          name="description"
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Mumbai" />
              </div>
            </div>
            <br />
            <div>
...
export default MumbaiEventSpaces
export const query = graphql`
  query MumbaiEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Mumbai" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
