...
const TrichyCoworkingSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
          title="Best coworking spaces in Trichy | Office for rent in Trichy | Gofloaters"
          description="Book furnished coworking spaces in Trichy for a day instantly. Great amenities and spacious coworking spaces available in Trichy for you to choose from."
        socialURL="https://assets.gofloaters.com/socialimage/coworking-spaces-in-trichy.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <OfficeSpaceLocationSwitch city="Trichy" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-trichy/" className="active">
                    Coworking Spaces
                  </Link>
                </li>
                
                <li>
                  <Link to="/meeting-rooms-in-trichy/">Meeting Spaces</Link>
                </li>
                <li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Coworking Spaces in Trichy available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default TrichyCoworkingSpace
export const query = graphql`
  query TrichyCoworkingSpace {
    allListings(
      filter: {
