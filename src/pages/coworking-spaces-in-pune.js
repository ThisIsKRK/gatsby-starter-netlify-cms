...
const PuneWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in Pune - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in Pune - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in Pune</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Pune" />
              </div>
            </div>
            <br />
            <div>
...
export default PuneWorkCafe
export const query = graphql`
  query PuneWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Pune" } }
    ) {
      totalCount
      edges {
        node {
