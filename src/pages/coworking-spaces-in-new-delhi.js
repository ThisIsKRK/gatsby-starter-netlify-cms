...
const NewDelhiWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in New Delhi - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in New Delhi - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          {" "}
          <h1>Coworking Spaces in New Delhi</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="New Delhi" />
              </div>
            </div>
            <br />
            <div>
...
export default NewDelhiWorkCafe
export const query = graphql`
  query NewDelhiWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "New Delhi" } }
    ) {
      totalCount
      edges {
        node {
