  ...
  return (
    <div>
      <SEOHeader
        ...
        description="Furnished & Ready-to-move-in office space for rent in Indore. Flexible plans that suit your needs. Coworking Spaces for teams. All-inclusive pricing."
        socialURL="https://assets.gofloaters.com/socialimage/indore.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        <div>
...
export const query = graphql`
  query Indore {
    allListings(
      filter: { subType: { eq: "Office Space" }, spaceCity: { eq: "Indore" } }
    ) {
      totalCount
      edges {
        node {
