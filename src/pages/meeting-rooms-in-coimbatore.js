...
import SocialImage from "../img/socialimage/meeting-rooms-in-coimbatore.jpg"
const CoimbatoreMeetingSpaces = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Book Conference Rooms & Meeting Rooms in Coimbatore at GoFloaters"
        description="Book Meeting Rooms In Coimbatore With GoFloaters. Conduct your meetings professionally with the well-equipped Conference rooms in Coimbatore."
        socialURL="https://assets.gofloaters.com/socialimage/meeting-rooms-in-coimbatore.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
        ...
        <div>
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <MeetingLocationSwitch city="Coimbatore" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-coimbatore/">
                    Coworking Spaces
                  </Link>
                </li>
              
                <li>
                  <Link to="/meeting-rooms-in-coimbatore/" className="active">
                    Meeting Spaces
                  </Link>
                </li>
                <li>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Meeting Spaces in Coimbatore available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default CoimbatoreMeetingSpaces
export const query = graphql`
  query CoimbatoreMeetingSpaces {
    allListings(
      filter: {
