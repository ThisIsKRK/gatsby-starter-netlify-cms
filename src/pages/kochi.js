    ...
    <div>
      <Helmet>
        <title>
          ...
          Event, Training spaces @ Kochi - GoFloaters
        </title>
        <meta
          name="description"
      ...
      <Layout>
        ...
        <div className="container">
          <ul className="ListingFilter DesktopOnly">
            ...
            <li>
              <Link to="/coworking-spaces-in-kochi/">Work Cafe</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/training-rooms-in-kochi/">Training Room</Link>
            </li>
            <li>
              <Link to="/event-spaces-in-kochi/">Event Spaces</Link>
            </li>
          </ul>
