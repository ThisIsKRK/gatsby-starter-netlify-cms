...
const NoidaEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Noida - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Noida - GoFloaters"
        ></meta>
        <meta
          name="description"
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Noida" />
              </div>
            </div>
            <br />
            <div>
...
export default NoidaEventSpaces
export const query = graphql`
  query NoidaEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Noida" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
