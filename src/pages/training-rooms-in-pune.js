...
const PuneTrainingRooms = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Training spaces on Hourly, Daily & Monthly Rental in Pune - GoFloaters
        </title>
        <meta
          property="og:title"
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <TrainingLocationSwitch city="Pune" />
              </div>
            </div>
            <br />
            <div>
...
export default PuneTrainingRooms
export const query = graphql`
  query PuneTrainingRooms {
    allListings(
      filter: { subType: { eq: "Training Room" }, spaceCity: { eq: "Pune" } }
    ) {
      totalCount
      edges {
        node {
