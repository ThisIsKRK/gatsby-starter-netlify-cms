...
const GaziabadEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Gaziabad - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Gaziabad - GoFloaters"
        ></meta>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="event-space">
          {" "}
          <h1>Event Spaces in Gaziabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Gaziabad" />
              </div>
            </div>
            <br />
            <div>
...
export default GaziabadEventSpaces
export const query = graphql`
  query GaziabadEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Gaziabad" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
