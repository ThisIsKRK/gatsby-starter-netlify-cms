...
const BengaluruCoworkingSpace = props => {
  ...
  return (
    <div>
      <SEOHeader
        ...
        description="Book furnished coworking spaces in Bengaluru for a day instantly. Great amenities and spacious coworking spaces available in Bengaluru for you to choose from."
          ...
          <div className="container">
            ...
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-bengaluru/" className="active">
                    Coworking Spaces
                  </Link>
                </li>
                <li>
                  <Link to="/meeting-rooms-in-bengaluru/">Meeting Spaces</Link>
                </li>{" "}
                <li>
                  <Link to="/office-spaces-for-rent-in-bengaluru/">
                    Office Spaces
                  </Link>
                </li>
              </ul>
...
export default BengaluruCoworkingSpace
export const query = graphql`
  query BengaluruCoworkingSpace {
    allListings(
      filter: {
