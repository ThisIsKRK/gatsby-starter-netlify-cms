...
const BengaluruWorkCafe = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Work Cafes | Coworking Spaces in Bengaluru - GoFloaters</title>
        <meta
          property="og:title"
          content="Work Cafes | Coworking Spaces in Bengaluru - GoFloaters"
        />
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="work-cafe">
          <h1>Coworking Spaces in Bengaluru</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <WorkSpaceLocationSwitch city="Bengaluru" />
              </div>
            </div>
            <br />
            <div>
...
export default BengaluruWorkCafe
export const query = graphql`
  query BengaluruWorkCafe {
    allListings(
      filter: { subType: { eq: "Work Cafe" }, spaceCity: { eq: "Bengaluru" } }
    ) {
      totalCount
      edges {
        node {
