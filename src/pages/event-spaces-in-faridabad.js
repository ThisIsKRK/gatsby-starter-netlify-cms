...
const FaridabadEventSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>Event spaces in Faridabad - GoFloaters</title>
        <meta
          name="og:title"
          content="Event spaces in Faridabad - GoFloaters"
        ></meta>
        <meta
          name="description"
      ...
      <Layout>
        <HeaderBanner headerclass="event-space">
          {" "}
          <h1>Event Spaces in Faridabad</h1>
        </HeaderBanner>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12">
                <br></br> <br></br>
                <EventSpaceLocationSwitch city="Faridabad" />
              </div>
            </div>
            <br />
            <div>
...
export default FaridabadEventSpaces
export const query = graphql`
  query FaridabadEventSpaces {
    allListings(
      filter: { spaceCity: { eq: "Faridabad" }, subType: { eq: "Event Space" } }
    ) {
      totalCount
      edges {
        node {
