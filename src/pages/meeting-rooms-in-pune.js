...
const PuneMeetingSpaces = props => {
  ...
  return (
    <div>
      <Helmet>
        <title>
          Meeting spaces on Hourly, Daily & Monthly Rental in Pune - GoFloaters
        </title>
        <meta
          property="og:title"
          content="Meeting spaces on Hourly, Daily & Monthly Rental in Pune - GoFloaters"
        />
        <meta
          name="description"
