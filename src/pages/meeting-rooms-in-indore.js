...
const IndoreMeetingRoom = props => {
  ...
  return (
    <div>
      <SEOHeader
        title="Book Conference Rooms & Meeting Rooms in Indore at GoFloaters"
        description="Book Meeting Rooms In Indore With GoFloaters. Conduct your meetings professionally with the well-equipped Conference rooms in Gurgram."
        socialURL="https://assets.gofloaters.com/socialimage/meeting-rooms-in-indore.jpg"
        pinterest="true"
      ></SEOHeader>
      <Layout>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12">
                <h1 className="listingpageTitle">Meeting Spaces in Indore</h1>
              ...
              <div className="col-md-12">
                <MeetingLocationSwitch city="Indore" />
              </div>
            </div>
            <div className="filterbar" style={{ marginTop: 15 }}>
              <ul className="SearchListingFilter scrollmenu">
                <li>
                  <Link to="/coworking-spaces-in-indore/">
                    Coworking Spaces
                  </Link>
                </li>
                
                <li>
                  <Link to="/meeting-rooms-in-indore/" className="active">
                    Meeting Spaces
                  </Link>
                </li>
                <li>
                  <Link to="/office-spaces-for-rent-in-indore/">
                    Office Spaces
                  </Link>
                </li>
              </ul>
        ...
        <div className="container">
          <p>
            <br></br>
            {spaceSize} Meeting Spaces in Indore available for you
          </p>
          <div className="row">
            {lists.map((list, i) => {
...
export default IndoreMeetingRoom
export const query = graphql`
  query IndoreMeetingRoom {
    allListings(
      filter: { subType: { eq: "Meeting Space" }, spaceCity: { eq: "Indore" } }
    ) {
      totalCount
      edges {
        node {
