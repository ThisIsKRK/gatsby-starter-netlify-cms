...
const NavigationHome = () => {
  ...
  const [scrollState, setscrollState] = useState("hometop")
  const handleScroll = () => {
    if (window.scrollY === 0) {
      setscrollState("hometop")
    } else if (window.scrollY !== 0) {
      setscrollState("homeonmoving")
    }
  }
        ...
        <div className="container-fluid">
          <nav className="navbar navbar-expand-lg navbar-light">
            <Link className="navbar-brand logo center-logo" to="/">
              ...
              />
              <img
                src="https://assets.gofloaters.com/gofloaters-white-logo.svg"
                alt="GoFloaters"
                className="whiteLogo"
              />
            </Link>
